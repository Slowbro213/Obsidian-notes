...
<p>
As shown in the image on the left, it may look like the project is split into four sections, given the four top-level directories. In reality it's just two:
</p>
<p>
